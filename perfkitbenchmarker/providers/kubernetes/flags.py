...
flags.DEFINE_enum('k8s_volume_provisioner', None, _K8S_PROVISIONERS,
                  ...
                  'classes.')
flags.DEFINE_multi_string('k8s_node_affinity_label', None,
                          'The <vm_group>:<label-key>=<label-value> pair to use when scheduling a pod. '
                          'E.g: --k8s_node_affinity_label=master:key1=value1 or '
                          '--k8s_node_affinity_label=target:key1=value1')
