...
*   [Tencent](#install-tencent-cli-and-setup-authentication)
*   [Yandex Cloud](#yandex-cloud-credentials)
...
### Install Tencent CLI and setup authentication
Make sure you have installed pip (see the section above).

Install the CLI with pip:
```bash
$ sudo pip install -r perfkitbenchmarker/providers/tencent/requirements.txt
```

Follow instructions for generating a Cloud API Key:
https://intl.cloud.tencent.com/document/product/213/6984
...
Generate Yandex Cloud IAM token from [guide](https://cloud.yandex.com/en/docs/iam/operations/iam-token/create)
and provide it via `YANDEX_IAM` environmental variable
